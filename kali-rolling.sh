...
mkdir -p ~/.themes/
timeout 300 curl -O -J --progress -k -L -f 'https://www.ppload.com/api/files/download?id=1461767736' -H 'Referer: https://www.xfce-look.org/content/show.php/axiom+xfwm?content=90145' --compressed > /tmp/axiom.tar.gz \
